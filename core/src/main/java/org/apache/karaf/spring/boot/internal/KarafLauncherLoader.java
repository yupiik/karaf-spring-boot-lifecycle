...
public class KarafLauncherLoader extends URLClassLoader {
    ...
    public KarafLauncherLoader(final BundleContext context,
                               final File baseOrJar, final ClassLoader parent) throws MalformedURLException {
